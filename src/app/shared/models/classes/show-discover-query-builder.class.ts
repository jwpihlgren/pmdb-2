import { ShowFilters } from "../interfaces/show-filters"
import QueryBuilder from "./query-builder.class"

type Operator = "or" | "and"

export default class ShowDiscoverQueryBuilder extends QueryBuilder<ShowDiscoverQueryBuilder> implements ShowFilters {
    ...
    firstAirDateLte = this.paramFactory<[number, number, number]>(this, "first_air_date.lte", (value: [number, number, number]) => {
