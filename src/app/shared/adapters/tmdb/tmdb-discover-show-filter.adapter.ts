...
export class TmdbDiscoverShowAdapter implements FilterAdapter<DiscoverShowFilters, Record<string, string>> {
    ...
    private readonly mapping: Record<keyof DiscoverShowFilters, TmdbFilterMapping> = {
        ...
        firstAirDateGte: { type: tmdbMappingTypes.DATE, externalKey: "first_air_date.gte", multi: false, allowedValues: [] },
        firstAirDateLte: { type: tmdbMappingTypes.DATE, externalKey: "first_air_date.lte", multi: false, allowedValues: [] },
